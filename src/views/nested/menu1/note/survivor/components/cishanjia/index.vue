      ...
      descriptionCN: [
        {
          role: '“慈善家”',
          type: '传闻',
          text: '将白沙街的孤儿院交给教会运营后，克利切并没有沉浸于纸醉金迷。他总是想着，也许我应当帮助更多孩子。当然，钱得从其他人口袋里掏。'
        },
        {
          role: '“慈善家”',
          type: '故事背景',
          text: '当教会有意在白沙街开设孤儿院的时候，皮尔森先生慷慨地将经营权和土地转赠给教会并离开了白沙街。尽管他获得了一笔为数不少的赔偿金，但对皮尔森先生而言，这笔钱不足以建设一所新的孤儿院，是时候从别人的口袋里掏出一点赞助金了。不过，也许他该先给自己找一位可心的搭档？'
        }
      ],
      deductionCN: [
        {
