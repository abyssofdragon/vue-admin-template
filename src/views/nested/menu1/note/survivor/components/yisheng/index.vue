      ...
      descriptionCN: [
        {
          role: '医生',
          type: '传闻',
          text: '要在这个疯狂的世界里存活，光行善举可不够――不是所有的病人都能得到妥善的照顾，也并非每位医者都怀着仁心仁德。'
        },
        {
          role: '医生',
          type: '故事背景',
          text: '她有野心，极其聪明看起来又不失真诚，但在那双眼睛后面还藏着更多东西，要在这个疯狂的世界里存活，有时候就得做些惊人之举。已经对不停地搬迁感到疲倦，艾米丽希望能借此找到一个可以被称为“家”的地方，并且最终得到她从未拥有的安全感和稳定生活。在此之前，她得解决过去遗留的一些”问题“。'
        }
      ],
      deductionCN: [
        {
