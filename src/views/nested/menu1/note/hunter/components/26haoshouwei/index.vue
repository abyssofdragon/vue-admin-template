      ...
      descriptionCN: [
        {
          role: '26号守卫',
          type: '传闻',
          text: '巴尔克的26号守卫型机器人，储存着大量定时炸弹。'
        },
        {
          role: '26号守卫',
          type: '故事背景',
          text: '巴尔克失败了二十五次，在最后一次他获得了26号，这曾是他最得意的作品。26号拥有极高的自主意识，这大大提升了它的工作效率，也让巴尔克得以暂时获得“假期”，远离繁杂重复的劳作，投入到新的机关设计里去。在此期间，26号的自我意识逐渐形成，它甚至拥有了一个“名字”——邦邦。巴尔克恼怒地发现26号的效率在自我意识的过度发展后逐渐降低，因此他更换了26号的中央枢纽并编写了新规则。奇怪的事情发生了，无论巴尔克更换多少次中央枢纽，修改多少次规则，26号在重启后都会播放同一句话：“很高兴认识你，邦邦。”'
        }
      ],
      deductionCN: [
        {
